...
#ifndef TimerStopApi_H_
#define TimerStopApi_H_
...
class TimerStopApi {
public:
  TimerStopApi(std::shared_ptr<Pistache::Rest::Router>);
  virtual ~TimerStopApi() {}
  void init();
...
private:
  ...
  void delete_timer_handler(const Pistache::Rest::Request &request,
                            Pistache::Http::ResponseWriter response);
  void timer_stop_api_default_handler(const Pistache::Rest::Request &request,
                                      Pistache::Http::ResponseWriter response);
  ...
  virtual void
  delete_timer(const std::string &realmId, const std::string &storageId,
