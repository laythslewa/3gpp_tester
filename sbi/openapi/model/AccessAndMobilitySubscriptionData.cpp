...
void AccessAndMobilitySubscriptionData::setSubscribedDnnList(
    std::vector<AnyOfstringstring> const &value) {
...
std::map<std::string, PlmnRestriction> &
AccessAndMobilitySubscriptionData::getAdjacentPlmnRestrictions() {
...
std::vector<PcfSelectionAssistanceInfo> &
AccessAndMobilitySubscriptionData::getPcfSelectionAssistanceInfos() {
...
void AccessAndMobilitySubscriptionData::setAerialUeSubInfo(
    AerialUeSubscriptionInfo const &value) {
