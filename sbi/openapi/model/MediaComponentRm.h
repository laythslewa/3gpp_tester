...
public:
  ...
  void unsetCodecs();
  /// <summary>
  /// string with format \&quot;float\&quot; as defined in OpenAPI with the
  /// OpenAPI defined \&quot;nullable&#x3D;true\&quot; property.
  /// </summary>
  ...
  /// the fNum attribute.
  /// </summary>
  std::map<std::string, MediaSubComponentRm> &getMedSubComps();
  void setMedSubComps(std::map<std::string, MediaSubComponentRm> const &value);
  ...
  ///
  /// </summary>
  PreemptionCapabilityRm getPreemptCap() const;
  void setPreemptCap(PreemptionCapabilityRm const &value);
  bool preemptCapIsSet() const;
  void unsetPreemptCap();
  /// <summary>
  ///
  /// </summary>
  PreemptionVulnerabilityRm getPreemptVuln() const;
  void setPreemptVuln(PreemptionVulnerabilityRm const &value);
  ...
  ///
  /// </summary>
  TsnQosContainerRm getTsnQos() const;
  void setTsnQos(TsnQosContainerRm const &value);
...
protected:
  ...
  std::map<std::string, MediaSubComponentRm> m_MedSubComps;
  ...
  bool m_MirBwUlIsSet;
  PreemptionCapabilityRm m_PreemptCap;
  bool m_PreemptCapIsSet;
  PreemptionVulnerabilityRm m_PreemptVuln;
