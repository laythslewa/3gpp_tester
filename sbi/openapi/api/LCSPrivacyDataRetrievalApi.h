...
public:
  LCSPrivacyDataRetrievalApi(std::shared_ptr<Pistache::Rest::Router>);
...
private:
  ...
  void get_lcs_privacy_data_handler(const Pistache::Rest::Request &request,
                                    Pistache::Http::ResponseWriter response);
  void lcs_privacy_data_retrieval_api_default_handler(
  ...
  /// &quot;&quot;)</param>
  virtual void get_lcs_privacy_data(
