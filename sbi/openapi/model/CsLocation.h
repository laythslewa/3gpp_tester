...
#ifndef CsLocation_H_
#define CsLocation_H_
...
public:
  ...
  ///
  /// </summary>
  GeraLocation getVlrLocation() const;
  void setVlrLocation(GeraLocation const &value);
  bool vlrLocationIsSet() const;
  void unsetVlrLocation();
  /// <summary>
  ///
  /// </summary>
  ...
  friend void to_json(nlohmann::json &j, const CsLocation &o);
  friend void from_json(const nlohmann::json &j, CsLocation &o);
...
protected:
  ...
  GeraLocation m_VlrLocation;
  bool m_VlrLocationIsSet;
