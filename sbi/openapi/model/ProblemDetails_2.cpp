...
void ProblemDetails_2::setInvalidParams(
    std::vector<InvalidParam_2> const &value) {
...
AccessTokenErr ProblemDetails_2::getAccessTokenError() const {
  return m_AccessTokenError;
}
void ProblemDetails_2::setAccessTokenError(AccessTokenErr const &value) {
  m_AccessTokenError = value;
  m_AccessTokenErrorIsSet = true;
}
bool ProblemDetails_2::accessTokenErrorIsSet() const {
  return m_AccessTokenErrorIsSet;
}
void ProblemDetails_2::unsetAccessTokenError() {
  m_AccessTokenErrorIsSet = false;
}
AccessTokenReq ProblemDetails_2::getAccessTokenRequest() const {
  return m_AccessTokenRequest;
}
void ProblemDetails_2::setAccessTokenRequest(AccessTokenReq const &value) {
  m_AccessTokenRequest = value;
  m_AccessTokenRequestIsSet = true;
}
bool ProblemDetails_2::accessTokenRequestIsSet() const {
  return m_AccessTokenRequestIsSet;
}
void ProblemDetails_2::unsetAccessTokenRequest() {
  m_AccessTokenRequestIsSet = false;
}
std::string ProblemDetails_2::getNrfId() const { return m_NrfId; }
void ProblemDetails_2::setNrfId(std::string const &value) {
  m_NrfId = value;
  m_NrfIdIsSet = true;
}
bool ProblemDetails_2::nrfIdIsSet() const { return m_NrfIdIsSet; }
void ProblemDetails_2::unsetNrfId() { m_NrfIdIsSet = false; }
