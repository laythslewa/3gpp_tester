...
void UeConnectivityState::validate() {
...
AccessType UeConnectivityState::getAccessType() const { return m_AccessType; }
void UeConnectivityState::setAccessType(AccessType const &value) {
  m_AccessType = value;
}
CmState UeConnectivityState::getConnectivitystate() const {
  return m_Connectivitystate;
}
void UeConnectivityState::setConnectivitystate(CmState const &value) {
