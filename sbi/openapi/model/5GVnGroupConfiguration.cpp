...
void 5GVnGroupConfiguration ::setMembers(
    std::vector<std::string> const &value) {
  m_Members = value;
  m_MembersIsSet = true;
}
bool 5GVnGroupConfiguration ::membersIsSet() const { return m_MembersIsSet; }
void 5GVnGroupConfiguration ::unsetMembers() { m_MembersIsSet = false; }
...
void 5GVnGroupConfiguration ::unsetReferenceId() { m_ReferenceIdIsSet = false; }
...
void 5GVnGroupConfiguration ::setInternalGroupIdentifier(
...
void 5GVnGroupConfiguration ::setMtcProviderInformation(
    std::string const &value) {
