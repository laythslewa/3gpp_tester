...
void CreateEESubscriptionApi::init() { setupRoutes(); }

void CreateEESubscriptionApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Post(
      *router, base + "/:ueIdentity/ee-subscriptions",
      Routes::bind(&CreateEESubscriptionApi::create_ee_subscription_handler,
                   this));
