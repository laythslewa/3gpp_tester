 ...
 */
/*
 * TimeSynchronizationExposureSubscriptionsApi.h
 *
 *
 */

#ifndef TimeSynchronizationExposureSubscriptionsApi_H_
#define TimeSynchronizationExposureSubscriptionsApi_H_
...
class TimeSynchronizationExposureSubscriptionsApi {
public:
  TimeSynchronizationExposureSubscriptionsApi(
      std::shared_ptr<Pistache::Rest::Router>);
  virtual ~TimeSynchronizationExposureSubscriptionsApi() {}
  void init();
...
private:
  ...
  af_id_subscriptions_post_handler(const Pistache::Rest::Request &request,
                                   Pistache::Http::ResponseWriter response);
  void time_synchronization_exposure_subscriptions_api_default_handler(
  ...
  /// </remarks>
  /// <param name="afId">Identifier of the AF</param>
  /// <param name="timeSyncExposureSubsc">new subscription creation</param>
  virtual void
...
#endif /* TimeSynchronizationExposureSubscriptionsApi_H_ */
