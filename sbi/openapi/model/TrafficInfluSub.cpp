...
std::vector<SubscribedEvent> &TrafficInfluSub::getSubscribedEvents() {
...
std::vector<FlowInfo> &TrafficInfluSub::getTrafficFilters() {
...
std::vector<EthFlowDescription> &TrafficInfluSub::getEthTrafficFilters() {
...
std::vector<RouteToLocation> &TrafficInfluSub::getTrafficRoutes() {
...
std::vector<TemporalValidity> &TrafficInfluSub::getTempValidities() {
...
std::vector<std::string> &TrafficInfluSub::getValidGeoZoneIds() {
...
UserPlaneLatencyRequirements TrafficInfluSub::getUpLatReq() const {
  return m_UpLatReq;
}
void TrafficInfluSub::setUpLatReq(UserPlaneLatencyRequirements const &value) {
  m_UpLatReq = value;
  m_UpLatReqIsSet = true;
}
bool TrafficInfluSub::upLatReqIsSet() const { return m_UpLatReqIsSet; }
void TrafficInfluSub::unsetUpLatReq() { m_UpLatReqIsSet = false; }
