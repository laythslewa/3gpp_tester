...
BlockCRUDApiImpl::BlockCRUDApiImpl(std::shared_ptr<Pistache::Rest::Router> rtr)
    : BlockCRUDApi(rtr) {}

void BlockCRUDApiImpl::create_or_modify_block(
...
void BlockCRUDApiImpl::delete_block(
    const std::string &realmId, const std::string &storageId,
    const std::string &recordId, const std::string &blockId,
...
void BlockCRUDApiImpl::get_block(
    const std::string &realmId, const std::string &storageId,
    const std::string &recordId, const std::string &blockId,
    const Pistache::Optional<Pistache::Http::Header::Raw> &ifNoneMatch,
...
void BlockCRUDApiImpl::get_block_list(
    const std::string &realmId, const std::string &storageId,
