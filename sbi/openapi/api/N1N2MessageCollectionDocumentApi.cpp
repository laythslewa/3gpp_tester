...
void N1N2MessageCollectionDocumentApi::init() { setupRoutes(); }
...
void N1N2MessageCollectionDocumentApi::setupRoutes() {
  ...
  router->addCustomHandler(
      Routes::bind(&N1N2MessageCollectionDocumentApi::
...
void N1N2MessageCollectionDocumentApi::n1_n2_message_transfer_handler(
  ...
  try {
    ...
    this->n1_n2_message_transfer(ueContextId, n1N2MessageTransferReqData,
                                 response);
