...
public:
  ...
  /// PlmnRestriction
  /// </summary>
  std::map<std::string, PlmnRestriction> &getAdjacentPlmnRestrictions();
  void setAdjacentPlmnRestrictions(
      std::map<std::string, PlmnRestriction> const &value);
  ...
  ///
  /// </summary>
  std::vector<PcfSelectionAssistanceInfo> &getPcfSelectionAssistanceInfos();
  void setPcfSelectionAssistanceInfos(
      std::vector<PcfSelectionAssistanceInfo> const &value);
  bool pcfSelectionAssistanceInfosIsSet() const;
  void unsetPcfSelectionAssistanceInfos();
  /// <summary>
  ///
  /// </summary>
  AerialUeSubscriptionInfo getAerialUeSubInfo() const;
  void setAerialUeSubInfo(AerialUeSubscriptionInfo const &value);
...
protected:
  ...
  std::map<std::string, PlmnRestriction> m_AdjacentPlmnRestrictions;
  ...
  std::vector<PcfSelectionAssistanceInfo> m_PcfSelectionAssistanceInfos;
  bool m_PcfSelectionAssistanceInfosIsSet;
  AerialUeSubscriptionInfo m_AerialUeSubInfo;
