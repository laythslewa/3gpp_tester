...
/*
 * LCSBroadcastAssistanceDataTypesRetrievalApiImpl.h
 *
 *
 */

#ifndef LCS_BROADCAST_ASSISTANCE_DATA_TYPES_RETRIEVAL_API_IMPL_H_
#define LCS_BROADCAST_ASSISTANCE_DATA_TYPES_RETRIEVAL_API_IMPL_H_
...
class LCSBroadcastAssistanceDataTypesRetrievalApiImpl
    : public org::openapitools::server::api::
          LCSBroadcastAssistanceDataTypesRetrievalApi {
public:
  LCSBroadcastAssistanceDataTypesRetrievalApiImpl(
      std::shared_ptr<Pistache::Rest::Router>);
  ~LCSBroadcastAssistanceDataTypesRetrievalApiImpl() {}

  void get_lcs_bca_data(
