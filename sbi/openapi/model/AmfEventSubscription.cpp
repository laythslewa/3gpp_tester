...
NFType AmfEventSubscription::getSourceNfType() const { return m_SourceNfType; }
void AmfEventSubscription::setSourceNfType(NFType const &value) {
...
void AmfEventSubscription::unsetSourceNfType() { m_SourceNfTypeIsSet = false; }
