...
PatchOperation PatchItem::getOp() const { return m_Op; }
void PatchItem::setOp(PatchOperation const &value) { m_Op = value; }
...
AnyType PatchItem::getValue() const { return m_Value; }
