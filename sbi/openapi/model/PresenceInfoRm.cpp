...
PresenceState PresenceInfoRm::getPresenceState() const {
  return m_PresenceState;
}
void PresenceInfoRm::setPresenceState(PresenceState const &value) {
...
std::vector<Tai> &PresenceInfoRm::getTrackingAreaList() {
  return m_TrackingAreaList;
}
void PresenceInfoRm::setTrackingAreaList(std::vector<Tai> const &value) {
...
std::vector<Ecgi> &PresenceInfoRm::getEcgiList() { return m_EcgiList; }
void PresenceInfoRm::setEcgiList(std::vector<Ecgi> const &value) {
  m_EcgiList = value;
...
std::vector<Ncgi> &PresenceInfoRm::getNcgiList() { return m_NcgiList; }
void PresenceInfoRm::setNcgiList(std::vector<Ncgi> const &value) {
  m_NcgiList = value;
...
std::vector<GlobalRanNodeId> &PresenceInfoRm::getGlobalRanNodeIdList() {
...
std::vector<GlobalRanNodeId> &PresenceInfoRm::getGlobaleNbIdList() {
