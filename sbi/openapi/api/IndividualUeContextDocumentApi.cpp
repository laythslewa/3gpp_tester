...
void IndividualUeContextDocumentApi::setupRoutes() {
  ...
  Routes::Post(
      *router, base + "/ue-contexts/:ueContextId/cancel-relocate",
      Routes::bind(
          &IndividualUeContextDocumentApi::cancel_relocate_ue_context_handler,
          this));
  Routes::Put(
      *router, base + "/ue-contexts/:ueContextId",
      Routes::bind(&IndividualUeContextDocumentApi::create_ue_context_handler,
                   this));
  Routes::Post(
      *router, base + "/ue-contexts/:ueContextId/assign-ebi",
      Routes::bind(&IndividualUeContextDocumentApi::e_bi_assignment_handler,
                   this));
  Routes::Post(
  ...
  Routes::Post(
      *router, base + "/ue-contexts/:ueContextId/release",
      Routes::bind(&IndividualUeContextDocumentApi::release_ue_context_handler,
                   this));
  Routes::Post(
      *router, base + "/ue-contexts/:ueContextId/relocate",
      Routes::bind(&IndividualUeContextDocumentApi::relocate_ue_context_handler,
                   this));
  Routes::Post(
...
void IndividualUeContextDocumentApi::cancel_relocate_ue_context_handler(
    const Pistache::Rest::Request &request,
    Pistache::Http::ResponseWriter response) {
  try {
    this->cancel_relocate_ue_context(request, response);
...
void IndividualUeContextDocumentApi::create_ue_context_handler(
    ...
    Pistache::Http::ResponseWriter response) {
  try {
    this->create_ue_context(request, response);
  } catch (nlohmann::detail::exception &e) {
    // send a 400 error
    response.send(Pistache::Http::Code::Bad_Request, e.what());
    return;
...
void IndividualUeContextDocumentApi::registration_status_update_handler(
  ...
  try {
    ...
    this->registration_status_update(ueContextId, ueRegStatusUpdateReqData,
                                     response);
  } catch (nlohmann::detail::exception &e) {
    // send a 400 error
    response.send(Pistache::Http::Code::Bad_Request, e.what());
...
void IndividualUeContextDocumentApi::relocate_ue_context_handler(
    const Pistache::Rest::Request &request,
    Pistache::Http::ResponseWriter response) {
  try {
    this->relocate_ue_context(request, response);
  } catch (nlohmann::detail::exception &e) {
    // send a 400 error
    response.send(Pistache::Http::Code::Bad_Request, e.what());
    return;
