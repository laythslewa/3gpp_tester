...
public:
  ...
  /// </summary>
  std::string getConfirmedExpires() const;
  void setConfirmedExpires(std::string const &value);
  bool confirmedExpiresIsSet() const;
  void unsetConfirmedExpires();
  /// <summary>
  ...
  friend void to_json(nlohmann::json &j, const CreatedSubscription &o);
  friend void from_json(const nlohmann::json &j, CreatedSubscription &o);

protected:
  int32_t m_DicEntryId;

  std::string m_ConfirmedExpires;
  bool m_ConfirmedExpiresIsSet;
