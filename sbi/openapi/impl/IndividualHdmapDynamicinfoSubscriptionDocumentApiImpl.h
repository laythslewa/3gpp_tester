...
#ifndef INDIVIDUAL_HDMAP_DYNAMICINFO_SUBSCRIPTION_DOCUMENT_API_IMPL_H_
#define INDIVIDUAL_HDMAP_DYNAMICINFO_SUBSCRIPTION_DOCUMENT_API_IMPL_H_
...
public:
  ...
  void delete_hd_map_dynamic_info_subscription(
