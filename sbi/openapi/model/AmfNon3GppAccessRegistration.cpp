...
std::string AmfNon3GppAccessRegistration::getSupi() const { return m_Supi; }
void AmfNon3GppAccessRegistration::setSupi(std::string const &value) {
  m_Supi = value;
  m_SupiIsSet = true;
}
bool AmfNon3GppAccessRegistration::supiIsSet() const { return m_SupiIsSet; }
void AmfNon3GppAccessRegistration::unsetSupi() { m_SupiIsSet = false; }
