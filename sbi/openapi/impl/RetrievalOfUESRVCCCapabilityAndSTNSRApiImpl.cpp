...
#include "RetrievalOfUESRVCCCapabilityAndSTNSRApiImpl.h"
...
RetrievalOfUESRVCCCapabilityAndSTNSRApiImpl::
    ...
    : RetrievalOfUESRVCCCapabilityAndSTNSRApi(rtr) {}

void RetrievalOfUESRVCCCapabilityAndSTNSRApiImpl::get_srvcc_data(
