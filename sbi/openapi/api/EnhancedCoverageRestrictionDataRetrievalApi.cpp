...
void EnhancedCoverageRestrictionDataRetrievalApi::init() { setupRoutes(); }

void EnhancedCoverageRestrictionDataRetrievalApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Get(
      *router, base + "/:supi/am-data/ecr-data",
      Routes::bind(
  ...
  router->addCustomHandler(Routes::bind(
      &EnhancedCoverageRestrictionDataRetrievalApi::
          enhanced_coverage_restriction_data_retrieval_api_default_handler,
      this));
}

void EnhancedCoverageRestrictionDataRetrievalApi::get_ecr_data_handler(
  ...
  try {
    this->get_ecr_data(supi, supportedFeatures, ifNoneMatch, ifModifiedSince,
                       response);
...
void EnhancedCoverageRestrictionDataRetrievalApi::
    enhanced_coverage_restriction_data_retrieval_api_default_handler(
