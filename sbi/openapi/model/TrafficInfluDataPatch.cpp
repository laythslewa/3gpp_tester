...
NetworkAreaInfo TrafficInfluDataPatch::getNwAreaInfo() const {
  return m_NwAreaInfo;
}
void TrafficInfluDataPatch::setNwAreaInfo(NetworkAreaInfo const &value) {
  m_NwAreaInfo = value;
...
UserPlaneLatencyRequirements TrafficInfluDataPatch::getUpLatReq() const {
  return m_UpLatReq;
}
void TrafficInfluDataPatch::setUpLatReq(
    UserPlaneLatencyRequirements const &value) {
  m_UpLatReq = value;
  m_UpLatReqIsSet = true;
}
bool TrafficInfluDataPatch::upLatReqIsSet() const { return m_UpLatReqIsSet; }
void TrafficInfluDataPatch::unsetUpLatReq() { m_UpLatReqIsSet = false; }
