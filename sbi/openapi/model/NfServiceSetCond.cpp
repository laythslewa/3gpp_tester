...
void NfServiceSetCond::validate() {
...
std::string NfServiceSetCond::getNfSetId() const { return m_NfSetId; }
void NfServiceSetCond::setNfSetId(std::string const &value) {
  m_NfSetId = value;
  m_NfSetIdIsSet = true;
}
bool NfServiceSetCond::nfSetIdIsSet() const { return m_NfSetIdIsSet; }
void NfServiceSetCond::unsetNfSetId() { m_NfSetIdIsSet = false; }
