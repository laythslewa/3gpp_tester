...
PlmnId PduSession::getPlmnId() const { return m_PlmnId; }
void PduSession::setPlmnId(PlmnId const &value) { m_PlmnId = value; }
Snssai PduSession::getSingleNssai() const { return m_SingleNssai; }
