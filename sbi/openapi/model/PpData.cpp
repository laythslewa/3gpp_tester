...
EcsServerAddr PpData::getEcsServerAddr() const { return m_EcsServerAddr; }
void PpData::setEcsServerAddr(EcsServerAddr const &value) {
  m_EcsServerAddr = value;
  m_EcsServerAddrIsSet = true;
}
bool PpData::ecsServerAddrIsSet() const { return m_EcsServerAddrIsSet; }
void PpData::unsetEcsServerAddr() { m_EcsServerAddrIsSet = false; }
