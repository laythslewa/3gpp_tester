...
public:
  ...
  ///
  /// </summary>
  std::vector<UserIdentifier> &getAuthorizationData();
  void setAuthorizationData(std::vector<UserIdentifier> const &value);
  /// <summary>
...
protected:
  std::vector<UserIdentifier> m_AuthorizationData;
