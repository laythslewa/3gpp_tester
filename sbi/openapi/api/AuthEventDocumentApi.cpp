...
void AuthEventDocumentApi::init() { setupRoutes(); }
...
void AuthEventDocumentApi::setupRoutes() {
  ...
  Routes::Delete(
      *router,
      ...
      Routes::bind(&AuthEventDocumentApi::delete_authentication_status_handler,
                   this));
  Routes::Get(
      *router,
      base +
          "/subscription-data/:ueId/authentication-data/authentication-status",
      Routes::bind(&AuthEventDocumentApi::query_authentication_status_handler,
                   this));

  // Default handler, called when a route is not found
  router->addCustomHandler(Routes::bind(
      &AuthEventDocumentApi::auth_event_document_api_default_handler, this));
}

void AuthEventDocumentApi::delete_authentication_status_handler(
...
void AuthEventDocumentApi::query_authentication_status_handler(
    const Pistache::Rest::Request &request,
    Pistache::Http::ResponseWriter response) {
  // Getting the path params
  auto ueId = request.param(":ueId").as<std::string>();
...
void AuthEventDocumentApi::auth_event_document_api_default_handler(
