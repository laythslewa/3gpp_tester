...
void LCSBroadcastAssistanceDataTypesRetrievalApi::init() { setupRoutes(); }

void LCSBroadcastAssistanceDataTypesRetrievalApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Get(*router, base + "/:supi/lcs-bca-data",
              Routes::bind(&LCSBroadcastAssistanceDataTypesRetrievalApi::
                               get_lcs_bca_data_handler,
                           this));

  // Default handler, called when a route is not found
  router->addCustomHandler(Routes::bind(
      &LCSBroadcastAssistanceDataTypesRetrievalApi::
          lcs_broadcast_assistance_data_types_retrieval_api_default_handler,
      this));
}

void LCSBroadcastAssistanceDataTypesRetrievalApi::get_lcs_bca_data_handler(
  ...
  try {
    this->get_lcs_bca_data(supi, supportedFeatures, plmnId, ifNoneMatch,
...
void LCSBroadcastAssistanceDataTypesRetrievalApi::
    lcs_broadcast_assistance_data_types_retrieval_api_default_handler(
