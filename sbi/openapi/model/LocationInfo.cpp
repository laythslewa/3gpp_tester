...
void to_json(nlohmann::json &j, const LocationInfo &o) {
  ...
  if (o.routingAreaIdIsSet())
    j["routingAreaId"] = o.m_RoutingAreaId;
  if (o.trackingAreaIdIsSet())
    j["trackingAreaId"] = o.m_TrackingAreaId;
  if (o.plmnIdIsSet())
    j["plmnId"] = o.m_PlmnId;
  if (o.twanIdIsSet())
    j["twanId"] = o.m_TwanId;
  if (o.geographicAreaIsSet())
    j["geographicArea"] = o.m_GeographicArea;
  if (o.civicAddressIsSet())
    j["civicAddress"] = o.m_CivicAddress;
  if (o.positionMethodIsSet())
    j["positionMethod"] = o.m_PositionMethod;
  if (o.qosFulfilIndIsSet())
    j["qosFulfilInd"] = o.m_QosFulfilInd;
  if (o.ueVelocityIsSet())
    j["ueVelocity"] = o.m_UeVelocity;
  if (o.ldrTypeIsSet())
