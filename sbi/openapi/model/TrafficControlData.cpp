...
FlowStatus TrafficControlData::getFlowStatus() const { return m_FlowStatus; }
...
std::vector<RouteToLocation> &TrafficControlData::getRouteToLocs() {
...
UserPlaneLatencyRequirements TrafficControlData::getUpLatReq() const {
  return m_UpLatReq;
}
void TrafficControlData::setUpLatReq(
    UserPlaneLatencyRequirements const &value) {
  m_UpLatReq = value;
  m_UpLatReqIsSet = true;
}
bool TrafficControlData::upLatReqIsSet() const { return m_UpLatReqIsSet; }
void TrafficControlData::unsetUpLatReq() { m_UpLatReqIsSet = false; }
