...
void EventsNotification::validate() {
...
std::vector<AppDetectionReport> &EventsNotification::getAdReports() {
  return m_AdReports;
}
...
AccessType EventsNotification::getAccessType() const { return m_AccessType; }
void EventsNotification::setAccessType(AccessType const &value) {
  m_AccessType = value;
...
AdditionalAccessInfo EventsNotification::getAddAccessInfo() const {
  return m_AddAccessInfo;
}
void EventsNotification::setAddAccessInfo(AdditionalAccessInfo const &value) {
...
AdditionalAccessInfo EventsNotification::getRelAccessInfo() const {
  return m_RelAccessInfo;
}
void EventsNotification::setRelAccessInfo(AdditionalAccessInfo const &value) {
...
AccNetChargingAddress EventsNotification::getAnChargAddr() const {
  return m_AnChargAddr;
}
void EventsNotification::setAnChargAddr(AccNetChargingAddress const &value) {
  m_AnChargAddr = value;
...
std::vector<AccessNetChargingIdentifier> &EventsNotification::getAnChargIds() {
  return m_AnChargIds;
}
...
AnGwAddress EventsNotification::getAnGwAddr() const { return m_AnGwAddr; }
void EventsNotification::setAnGwAddr(AnGwAddress const &value) {
  m_AnGwAddr = value;
...
std::vector<AfEventNotification> &EventsNotification::getEvNotifs() {
  return m_EvNotifs;
}
...
EventsNotification::getFailedResourcAllocReports() {
...
std::vector<ResourcesAllocationInfo> &
EventsNotification::getSuccResourcAllocReports() {
...
NetLocAccessSupport EventsNotification::getNoNetLocSupp() const {
  return m_NoNetLocSupp;
}
void EventsNotification::setNoNetLocSupp(NetLocAccessSupport const &value) {
...
std::vector<OutOfCreditInformation> &EventsNotification::getOutOfCredReports() {
...
PlmnIdNid EventsNotification::getPlmnId() const { return m_PlmnId; }
void EventsNotification::setPlmnId(PlmnIdNid const &value) {
  m_PlmnId = value;
  m_PlmnIdIsSet = true;
}
bool EventsNotification::plmnIdIsSet() const { return m_PlmnIdIsSet; }
void EventsNotification::unsetPlmnId() { m_PlmnIdIsSet = false; }
std::vector<QosNotificationControlInfo> &EventsNotification::getQncReports() {
  return m_QncReports;
}
...
std::vector<QosMonitoringReport> &EventsNotification::getQosMonReports() {
...
std::vector<RanNasRelCause> &EventsNotification::getRanNasRelCauses() {
...
RatType EventsNotification::getRatType() const { return m_RatType; }
void EventsNotification::setRatType(RatType const &value) {
  m_RatType = value;
  m_RatTypeIsSet = true;
}
...
SatelliteBackhaulCategory EventsNotification::getSatBackhaulCategory() const {
...
UserLocation EventsNotification::getUeLoc() const { return m_UeLoc; }
void EventsNotification::setUeLoc(UserLocation const &value) {
  m_UeLoc = value;
  m_UeLocIsSet = true;
}
...
AccumulatedUsage EventsNotification::getUsgRep() const { return m_UsgRep; }
void EventsNotification::setUsgRep(AccumulatedUsage const &value) {
  m_UsgRep = value;
  m_UsgRepIsSet = true;
}
bool EventsNotification::usgRepIsSet() const { return m_UsgRepIsSet; }
void EventsNotification::unsetUsgRep() { m_UsgRepIsSet = false; }
BridgeManagementContainer EventsNotification::getTsnBridgeManCont() const {
...
PortManagementContainer EventsNotification::getTsnPortManContDstt() const {
...
EventsNotification::getTsnPortManContNwtts() {
