...
void CnAssistedRanPara::validate() {
...
StationaryIndication CnAssistedRanPara::getStationaryIndication() const {
...
int32_t CnAssistedRanPara::getPeriodicTime() const { return m_PeriodicTime; }
...
void CnAssistedRanPara::unsetPeriodicTime() { m_PeriodicTimeIsSet = false; }
...
TrafficProfile CnAssistedRanPara::getTrafficProfile() const {
  return m_TrafficProfile;
}
void CnAssistedRanPara::setTrafficProfile(TrafficProfile const &value) {
...
void CnAssistedRanPara::unsetTrafficProfile() { m_TrafficProfileIsSet = false; }
BatteryIndication CnAssistedRanPara::getBatteryIndication() const {
  return m_BatteryIndication;
}
void CnAssistedRanPara::setBatteryIndication(BatteryIndication const &value) {
