...
RefToBinaryData N1N2MessageTransferReqData::getMtData() const {
  return m_MtData;
}
void N1N2MessageTransferReqData::setMtData(RefToBinaryData const &value) {
  m_MtData = value;
  m_MtDataIsSet = true;
}
...
Arp N1N2MessageTransferReqData::getArp() const { return m_Arp; }
...
Guami N1N2MessageTransferReqData::getOldGuami() const { return m_OldGuami; }
void N1N2MessageTransferReqData::setOldGuami(Guami const &value) {
  m_OldGuami = value;
...
AccessType N1N2MessageTransferReqData::getTargetAccess() const {
  return m_TargetAccess;
}
void N1N2MessageTransferReqData::setTargetAccess(AccessType const &value) {
