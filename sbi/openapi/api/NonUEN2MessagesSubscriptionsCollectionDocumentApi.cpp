...
void NonUEN2MessagesSubscriptionsCollectionDocumentApi::setupRoutes() {
  ...
  Routes::Post(*router, base + "/non-ue-n2-messages/subscriptions",
               Routes::bind(&NonUEN2MessagesSubscriptionsCollectionDocumentApi::
...
void NonUEN2MessagesSubscriptionsCollectionDocumentApi::
    non_ue_n2_info_subscribe_handler(const Pistache::Rest::Request &request,
