 ...
 */
/*
 * ProseSubscriptionDataRetrievalApi.h
 *
 *
 */

#ifndef ProseSubscriptionDataRetrievalApi_H_
#define ProseSubscriptionDataRetrievalApi_H_
...
class ProseSubscriptionDataRetrievalApi {
public:
  ProseSubscriptionDataRetrievalApi(std::shared_ptr<Pistache::Rest::Router>);
  virtual ~ProseSubscriptionDataRetrievalApi() {}
  void init();
...
private:
  ...
  void get_prose_data_handler(const Pistache::Rest::Request &request,
                              Pistache::Http::ResponseWriter response);
  void prose_subscription_data_retrieval_api_default_handler(
...
#endif /* ProseSubscriptionDataRetrievalApi_H_ */
