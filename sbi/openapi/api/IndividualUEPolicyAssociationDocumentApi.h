 ...
 */
/*
 * IndividualUEPolicyAssociationDocumentApi.h
 *
 *
 */

#ifndef IndividualUEPolicyAssociationDocumentApi_H_
#define IndividualUEPolicyAssociationDocumentApi_H_
...
class IndividualUEPolicyAssociationDocumentApi {
public:
  IndividualUEPolicyAssociationDocumentApi(
      std::shared_ptr<Pistache::Rest::Router>);
  virtual ~IndividualUEPolicyAssociationDocumentApi() {}
  void init();
...
private:
  ...
  void delete_individual_ue_policy_association_handler(
      const Pistache::Rest::Request &request,
      Pistache::Http::ResponseWriter response);
  void read_individual_ue_policy_association_handler(
      const Pistache::Rest::Request &request,
      Pistache::Http::ResponseWriter response);
  void
  report_observed_event_triggers_for_individual_ue_policy_association_handler(
      const Pistache::Rest::Request &request,
      Pistache::Http::ResponseWriter response);
  void individual_ue_policy_association_document_api_default_handler(
      const Pistache::Rest::Request &request,
      Pistache::Http::ResponseWriter response);
  ...
  virtual void delete_individual_ue_policy_association(
  ...
  /// </remarks>
  /// <param name="polAssoId">Identifier of a policy association</param>
  virtual void read_individual_ue_policy_association(
      const std::string &polAssoId,
      Pistache::Http::ResponseWriter &response) = 0;
...
#endif /* IndividualUEPolicyAssociationDocumentApi_H_ */
