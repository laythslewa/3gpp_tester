...
NetworkAreaInfo TrafficInfluData::getNwAreaInfo() const { return m_NwAreaInfo; }
void TrafficInfluData::setNwAreaInfo(NetworkAreaInfo const &value) {
  m_NwAreaInfo = value;
...
UserPlaneLatencyRequirements TrafficInfluData::getUpLatReq() const {
  return m_UpLatReq;
}
void TrafficInfluData::setUpLatReq(UserPlaneLatencyRequirements const &value) {
  m_UpLatReq = value;
  m_UpLatReqIsSet = true;
}
bool TrafficInfluData::upLatReqIsSet() const { return m_UpLatReqIsSet; }
void TrafficInfluData::unsetUpLatReq() { m_UpLatReqIsSet = false; }
