...
private:
  ...
  void
  non3_gpp_smsf_deregistration_handler(const Pistache::Rest::Request &request,
  ...
  virtual void
  non3_gpp_smsf_deregistration(const std::string &ueId,
                               const Pistache::Optional<std::string> &smsfSetId,
