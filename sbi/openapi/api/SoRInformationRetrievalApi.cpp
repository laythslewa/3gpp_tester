...
SoRInformationRetrievalApi::SoRInformationRetrievalApi(
    std::shared_ptr<Pistache::Rest::Router> rtr) {
  router = rtr;
}

void SoRInformationRetrievalApi::init() { setupRoutes(); }

void SoRInformationRetrievalApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Get(
      *router, base + "/:supi/sor-information",
      Routes::bind(&SoRInformationRetrievalApi::get_sor_information_handler,
                   this));

  // Default handler, called when a route is not found
  router->addCustomHandler(
      Routes::bind(&SoRInformationRetrievalApi::
                       so_r_information_retrieval_api_default_handler,
                   this));
}

void SoRInformationRetrievalApi::get_sor_information_handler(
  ...
  try {
    this->get_sor_information(supi, plmnId, supportedFeatures, accessType,
                              response);
...
void SoRInformationRetrievalApi::so_r_information_retrieval_api_default_handler(
