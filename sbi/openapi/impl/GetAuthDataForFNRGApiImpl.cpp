...
#include "GetAuthDataForFNRGApiImpl.h"
...
GetAuthDataForFNRGApiImpl::GetAuthDataForFNRGApiImpl(
    std::shared_ptr<Pistache::Rest::Router> rtr)
    : GetAuthDataForFNRGApi(rtr) {}

void GetAuthDataForFNRGApiImpl::get_rg_auth_data(
