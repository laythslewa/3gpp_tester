...
#ifndef DeliverError_H_
#define DeliverError_H_
...
public:
  DeliverError();
  virtual ~DeliverError();

  void validate();

  /////////////////////////////////////////////
  /// DeliverError members
  ...
  friend void to_json(nlohmann::json &j, const DeliverError &o);
  friend void from_json(const nlohmann::json &j, DeliverError &o);
