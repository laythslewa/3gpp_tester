...
void CompleteStoredSearchDocumentApi::init() { setupRoutes(); }

void CompleteStoredSearchDocumentApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Get(
      *router, base + "/searches/:searchId/complete",
      Routes::bind(
  ...
  router->addCustomHandler(
      Routes::bind(&CompleteStoredSearchDocumentApi::
...
void CompleteStoredSearchDocumentApi::retrieve_complete_search_handler(
  ...
  try {
    this->retrieve_complete_search(searchId, acceptEncoding, response);
