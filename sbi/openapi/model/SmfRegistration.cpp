...
std::string SmfRegistration::getPcfId() const { return m_PcfId; }
void SmfRegistration::setPcfId(std::string const &value) {
  m_PcfId = value;
  m_PcfIdIsSet = true;
}
bool SmfRegistration::pcfIdIsSet() const { return m_PcfIdIsSet; }
void SmfRegistration::unsetPcfId() { m_PcfIdIsSet = false; }
