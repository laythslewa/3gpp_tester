...
class IndividualSMContextDocumentApiImpl
    : public org::openapitools::server::api::IndividualSMContextDocumentApi {
public:
  IndividualSMContextDocumentApiImpl(std::shared_ptr<Pistache::Rest::Router>);
  ~IndividualSMContextDocumentApiImpl() {}
