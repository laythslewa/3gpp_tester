...
N2SmInformation N2InfoContainer::getSmInfo() const { return m_SmInfo; }
...
N2RanInformation N2InfoContainer::getRanInfo() const { return m_RanInfo; }
...
NrppaInformation N2InfoContainer::getNrppaInfo() const { return m_NrppaInfo; }
...
PwsInformation N2InfoContainer::getPwsInfo() const { return m_PwsInfo; }
...
V2xInformation N2InfoContainer::getV2xInfo() const { return m_V2xInfo; }
void N2InfoContainer::setV2xInfo(V2xInformation const &value) {
  m_V2xInfo = value;
  m_V2xInfoIsSet = true;
}
