...
void EventExposureSubscriptionDocumentApi::init() { setupRoutes(); }
...
void EventExposureSubscriptionDocumentApi::setupRoutes() {
  ...
  router->addCustomHandler(
      Routes::bind(&EventExposureSubscriptionDocumentApi::
...
void EventExposureSubscriptionDocumentApi::modify_eesubscription_handler(
  ...
  try {
    ...
    this->modify_eesubscription(ueId, subsId, patchItem, supportedFeatures,
                                response);
