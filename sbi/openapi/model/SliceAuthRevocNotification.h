 ...
 */
/*
 * SliceAuthRevocNotification.h
 *
 *
 */

#ifndef SliceAuthRevocNotification_H_
#define SliceAuthRevocNotification_H_
...
///
/// </summary>
class SliceAuthRevocNotification {
public:
  SliceAuthRevocNotification();
  virtual ~SliceAuthRevocNotification();

  void validate();

  /////////////////////////////////////////////
  /// SliceAuthRevocNotification members
  ...
  friend void to_json(nlohmann::json &j, const SliceAuthRevocNotification &o);
  friend void from_json(const nlohmann::json &j, SliceAuthRevocNotification &o);
...
#endif /* SliceAuthRevocNotification_H_ */
