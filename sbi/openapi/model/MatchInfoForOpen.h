 ...
 * be used for charging purpose for the open discovery type.
 */

#ifndef MatchInfoForOpen_H_
#define MatchInfoForOpen_H_
...
/// </summary>
class MatchInfoForOpen {
public:
  MatchInfoForOpen();
  virtual ~MatchInfoForOpen();

  void validate();

  /////////////////////////////////////////////
  /// MatchInfoForOpen members
  ...
  void setAppId(std::vector<std::string> const &value);

  friend void to_json(nlohmann::json &j, const MatchInfoForOpen &o);
  friend void from_json(const nlohmann::json &j, MatchInfoForOpen &o);

protected:
  std::string m_Supi;

  std::vector<std::string> m_AppId;
};
