...
private:
  ...
  void
  cancel_relocate_ue_context_handler(const Pistache::Rest::Request &request,
                                     Pistache::Http::ResponseWriter response);
  void create_ue_context_handler(const Pistache::Rest::Request &request,
                                 Pistache::Http::ResponseWriter response);
  void e_bi_assignment_handler(const Pistache::Rest::Request &request,
                               Pistache::Http::ResponseWriter response);
  void
  registration_status_update_handler(const Pistache::Rest::Request &request,
                                     Pistache::Http::ResponseWriter response);
  void release_ue_context_handler(const Pistache::Rest::Request &request,
                                  Pistache::Http::ResponseWriter response);
  void relocate_ue_context_handler(const Pistache::Rest::Request &request,
                                   Pistache::Http::ResponseWriter response);
  void u_e_context_transfer_handler(const Pistache::Rest::Request &request,
                                    Pistache::Http::ResponseWriter response);
  ...
  /// </remarks>
  virtual void
  cancel_relocate_ue_context(const Pistache::Rest::Request &request,
  ...
  ///
  /// </remarks>
  virtual void create_ue_context(const Pistache::Rest::Request &request,
                                 Pistache::Http::ResponseWriter &response) = 0;
  ...
  virtual void e_bi_assignment(const std::string &ueContextId,
  ...
  virtual void release_ue_context(const std::string &ueContextId,
  ...
  /// </remarks>
  virtual void
  relocate_ue_context(const Pistache::Rest::Request &request,
                      Pistache::Http::ResponseWriter &response) = 0;
