...
public:
  V2XSubscriptionDataRetrievalApi(std::shared_ptr<Pistache::Rest::Router>);
...
private:
  ...
  void get_v2x_data_handler(const Pistache::Rest::Request &request,
                            Pistache::Http::ResponseWriter response);
  void v2_x_subscription_data_retrieval_api_default_handler(
