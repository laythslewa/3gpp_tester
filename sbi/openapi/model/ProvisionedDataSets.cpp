...
ProseSubscriptionData ProvisionedDataSets::getProseData() const {
  return m_ProseData;
}
void ProvisionedDataSets::setProseData(ProseSubscriptionData const &value) {
  m_ProseData = value;
  m_ProseDataIsSet = true;
}
bool ProvisionedDataSets::proseDataIsSet() const { return m_ProseDataIsSet; }
void ProvisionedDataSets::unsetProseData() { m_ProseDataIsSet = false; }
