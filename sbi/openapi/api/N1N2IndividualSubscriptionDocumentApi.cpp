...
void N1N2IndividualSubscriptionDocumentApi::init() { setupRoutes(); }

void N1N2IndividualSubscriptionDocumentApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Delete(*router,
                 base + "/ue-contexts/:ueContextId/n1-n2-messages/"
                        "subscriptions/:subscriptionId",
                 Routes::bind(&N1N2IndividualSubscriptionDocumentApi::
