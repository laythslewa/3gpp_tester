...
void NonUEN2MessagesCollectionDocumentApi::init() { setupRoutes(); }

void NonUEN2MessagesCollectionDocumentApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Post(*router, base + "/non-ue-n2-messages/transfer",
               Routes::bind(&NonUEN2MessagesCollectionDocumentApi::
