...
void OperatorSpecificDataDocumentApi::setupRoutes() {
  ...
  Routes::Delete(*router,
                 base + "/policy-data/ues/:ueId/operator-specific-data",
                 Routes::bind(&OperatorSpecificDataDocumentApi::
                                  delete_operator_specific_data_handler,
                              this));
  Routes::Get(
...
void OperatorSpecificDataDocumentApi::delete_operator_specific_data_handler(
  ...
  try {
    this->delete_operator_specific_data(ueId, response);
