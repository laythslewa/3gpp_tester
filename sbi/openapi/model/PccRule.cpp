...
std::vector<FlowInformation> &PccRule::getFlowInfos() { return m_FlowInfos; }
...
AfSigProtocol PccRule::getAfSigProtocol() const { return m_AfSigProtocol; }
...
std::vector<std::string> &PccRule::getRefQosData() { return m_RefQosData; }
...
std::vector<std::string> &PccRule::getRefAltQosParams() {
...
std::vector<std::string> &PccRule::getRefTcData() { return m_RefTcData; }
...
std::vector<std::string> &PccRule::getRefChgData() { return m_RefChgData; }
...
std::vector<std::string> &PccRule::getRefChgN3gData() {
...
std::vector<std::string> &PccRule::getRefUmData() { return m_RefUmData; }
...
std::vector<std::string> &PccRule::getRefUmN3gData() { return m_RefUmN3gData; }
...
std::vector<std::string> &PccRule::getRefQosMon() { return m_RefQosMon; }
...
TscaiInputContainer PccRule::getTscaiInputDl() const { return m_TscaiInputDl; }
...
TscaiInputContainer PccRule::getTscaiInputUl() const { return m_TscaiInputUl; }
...
int32_t PccRule::getTscaiTimeDom() const { return m_TscaiTimeDom; }
void PccRule::setTscaiTimeDom(int32_t const value) {
  m_TscaiTimeDom = value;
  m_TscaiTimeDomIsSet = true;
}
bool PccRule::tscaiTimeDomIsSet() const { return m_TscaiTimeDomIsSet; }
void PccRule::unsetTscaiTimeDom() { m_TscaiTimeDomIsSet = false; }
DownlinkDataNotificationControl PccRule::getDdNotifCtrl() const {
  return m_DdNotifCtrl;
}
void PccRule::setDdNotifCtrl(DownlinkDataNotificationControl const &value) {
  m_DdNotifCtrl = value;
...
DownlinkDataNotificationControlRm PccRule::getDdNotifCtrl2() const {
  return m_DdNotifCtrl2;
}
void PccRule::setDdNotifCtrl2(DownlinkDataNotificationControlRm const &value) {
