...
void IndividualAMPolicyAssociationDocumentApi::init() { setupRoutes(); }

void IndividualAMPolicyAssociationDocumentApi::setupRoutes() {
  using namespace Pistache::Rest;

  Routes::Delete(
      *router, base + "/policies/:polAssoId",
      Routes::bind(&IndividualAMPolicyAssociationDocumentApi::
                       delete_individual_am_policy_association_handler,
                   this));
  Routes::Get(*router, base + "/policies/:polAssoId",
              Routes::bind(&IndividualAMPolicyAssociationDocumentApi::
                               read_individual_am_policy_association_handler,
                           this));
  Routes::Post(
  ...
  router->addCustomHandler(Routes::bind(
      &IndividualAMPolicyAssociationDocumentApi::
          individual_am_policy_association_document_api_default_handler,
      this));
}

void IndividualAMPolicyAssociationDocumentApi::
    delete_individual_am_policy_association_handler(
  ...
  try {
    this->delete_individual_am_policy_association(polAssoId, response);
...
void IndividualAMPolicyAssociationDocumentApi::
  ...
  try {
    this->read_individual_am_policy_association(polAssoId, response);
  } catch (nlohmann::detail::exception &e) {
    // send a 400 error
    response.send(Pistache::Http::Code::Bad_Request, e.what());
    return;
...
void IndividualAMPolicyAssociationDocumentApi::
  ...
  try {
    ...
    this->report_observed_event_triggers_for_individual_am_policy_association(
