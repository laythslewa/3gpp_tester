...
void to_json(nlohmann::json &j, const EventNotification &o) {
  ...
  if (o.gpsiIsSet())
    j["gpsi"] = o.m_Gpsi;
  if (o.srcUeIpv4AddrIsSet())
    j["srcUeIpv4Addr"] = o.m_SrcUeIpv4Addr;
  if (o.srcUeIpv6PrefixIsSet())
    j["srcUeIpv6Prefix"] = o.m_SrcUeIpv6Prefix;
  if (o.tgtUeIpv4AddrIsSet())
    j["tgtUeIpv4Addr"] = o.m_TgtUeIpv4Addr;
  if (o.tgtUeIpv6PrefixIsSet())
    j["tgtUeIpv6Prefix"] = o.m_TgtUeIpv6Prefix;
  if (o.ueMacIsSet())
    j["ueMac"] = o.m_UeMac;
  if (o.afAckUriIsSet())
    j["afAckUri"] = o.m_AfAckUri;
}
