...
UmtTime LocationArea::getUmtTime() const { return m_UmtTime; }
void LocationArea::setUmtTime(UmtTime const &value) {
  m_UmtTime = value;
  m_UmtTimeIsSet = true;
}
bool LocationArea::umtTimeIsSet() const { return m_UmtTimeIsSet; }
void LocationArea::unsetUmtTime() { m_UmtTimeIsSet = false; }
