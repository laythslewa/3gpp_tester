...
std::string Amf3GppAccessRegistration::getSupi() const { return m_Supi; }
void Amf3GppAccessRegistration::setSupi(std::string const &value) {
  m_Supi = value;
  m_SupiIsSet = true;
}
bool Amf3GppAccessRegistration::supiIsSet() const { return m_SupiIsSet; }
void Amf3GppAccessRegistration::unsetSupi() { m_SupiIsSet = false; }
UeReachableInd Amf3GppAccessRegistration::getUeReachableInd() const {
  return m_UeReachableInd;
}
void Amf3GppAccessRegistration::setUeReachableInd(UeReachableInd const &value) {
