...
public:
  LCSMobileOriginatedDataRetrievalApi(std::shared_ptr<Pistache::Rest::Router>);
...
private:
  ...
  void get_lcs_mo_data_handler(const Pistache::Rest::Request &request,
                               Pistache::Http::ResponseWriter response);
  void lcs_mobile_originated_data_retrieval_api_default_handler(
