...
public:
  ...
  /// </summary>
  std::string getUcmfNotificationUri() const;
  void setUcmfNotificationUri(std::string const &value);
  /// <summary>
  /// string with format \&quot;date-time\&quot; as defined in OpenAPI.
  /// </summary>
  std::string getSuggestedExpires() const;
  void setSuggestedExpires(std::string const &value);
  bool suggestedExpiresIsSet() const;
  void unsetSuggestedExpires();
  /// <summary>
  ...
  friend void to_json(nlohmann::json &j, const CreateSubscription &o);
  friend void from_json(const nlohmann::json &j, CreateSubscription &o);
