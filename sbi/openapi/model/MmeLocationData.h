...
#ifndef MmeLocationData_H_
#define MmeLocationData_H_
...
///
/// </summary>
class MmeLocationData {
public:
  MmeLocationData();
  virtual ~MmeLocationData();

  void validate();

  /////////////////////////////////////////////
  /// MmeLocationData members

  /// <summary>
  /// string containing an FQDN or realm as defined in RFC 6733.
  /// </summary>
  std::string getMmeAddress() const;
  void setMmeAddress(std::string const &value);
  /// <summary>
  ///
  /// </summary>
  ...
  ///
  /// </summary>
  EutraLocation getMmeLocation() const;
  void setMmeLocation(EutraLocation const &value);
  bool mmeLocationIsSet() const;
  void unsetMmeLocation();
  /// <summary>
  ///
  /// </summary>
  ...
  friend void to_json(nlohmann::json &j, const MmeLocationData &o);
  friend void from_json(const nlohmann::json &j, MmeLocationData &o);

protected:
  std::string m_MmeAddress;

  PlmnId m_PlmnId;

  EutraLocation m_MmeLocation;
  bool m_MmeLocationIsSet;
