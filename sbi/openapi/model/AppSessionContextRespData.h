...
public:
  ...
  virtual ~AppSessionContextRespData();
  ...
  ///
  /// </summary>
  std::vector<UeIdentityInfo> &getUeIds();
  void setUeIds(std::vector<UeIdentityInfo> const &value);
...
protected:
  ...
  std::vector<UeIdentityInfo> m_UeIds;
  bool m_UeIdsIsSet;
