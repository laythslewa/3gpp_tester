...
void AuthenticationDataDocumentApi::init() { setupRoutes(); }
...
void AuthenticationDataDocumentApi::setupRoutes() {
  ...
  Routes::Get(
      *router,
      ...
      Routes::bind(&AuthenticationDataDocumentApi::query_auth_subs_data_handler,
                   this));

  // Default handler, called when a route is not found
  router->addCustomHandler(
      Routes::bind(&AuthenticationDataDocumentApi::
                       authentication_data_document_api_default_handler,
                   this));
}

void AuthenticationDataDocumentApi::query_auth_subs_data_handler(
