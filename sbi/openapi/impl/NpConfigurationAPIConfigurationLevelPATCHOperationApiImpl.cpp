...
#include "NpConfigurationAPIConfigurationLevelPATCHOperationApiImpl.h"
...
NpConfigurationAPIConfigurationLevelPATCHOperationApiImpl::
    ...
    : NpConfigurationAPIConfigurationLevelPATCHOperationApi(rtr) {}

void NpConfigurationAPIConfigurationLevelPATCHOperationApiImpl::
    scs_as_id_configurations_configuration_id_patch(
