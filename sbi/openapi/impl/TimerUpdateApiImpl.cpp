...
TimerUpdateApiImpl::TimerUpdateApiImpl(
    std::shared_ptr<Pistache::Rest::Router> rtr)
    : TimerUpdateApi(rtr) {}

void TimerUpdateApiImpl::update_timer(
    const std::string &realmId, const std::string &storageId,
    const std::string &timerId, const std::vector<PatchItem> &patchItem,
