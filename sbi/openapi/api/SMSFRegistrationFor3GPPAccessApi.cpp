...
void SMSFRegistrationFor3GPPAccessApi::init() { setupRoutes(); }
...
void SMSFRegistrationFor3GPPAccessApi::setupRoutes() {
  ...
  Routes::Put(
      *router, base + "/:ueId/registrations/smsf-3gpp-access",
      Routes::bind(
          &SMSFRegistrationFor3GPPAccessApi::3_gpp_smsf_registration_handler,
          this));

  // Default handler, called when a route is not found
  router->addCustomHandler(
      Routes::bind(&SMSFRegistrationFor3GPPAccessApi::
                       smsf_registration_for3_gpp_access_api_default_handler,
                   this));
}

void SMSFRegistrationFor3GPPAccessApi::3_gpp_smsf_registration_handler(
